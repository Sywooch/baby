...
/**
 * Class m150318_092307_add_blog_rubric_tables_lang */
class m150318_092307_add_blog_rubric_tables_lang extends Migration
{
    /**
     ...
     */
    public $relatedTableName = '{{%blog_rubric_lang}}';
    ...
    public function safeUp()
    {
        ...
        $this->addForeignKey(
            'fk_blog_rubric_lang_model_id_to_main_model_id',
            $this->relatedTableName,
            'model_id',
            $this->tableName,
            'id',
        ...
        $this->addForeignKey(
            'fk_blog_rubric_lang_lang_id_to_language_id',
            $this->relatedTableName,
            'lang_id',
            '{{%language}}',
            'locale',
