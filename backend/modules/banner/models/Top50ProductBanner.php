 ...
 */
class Top50ProductBanner extends \backend\components\BackModel
{
    /**
     * @inheritdoc
     */
    ...
    */
    ...
    {
        $query = static::find()->where(['type' => Banner::TYPE_TOP_50]);
