 ...
 */
class NewProductBanner extends \backend\components\BackModel
{
    /**
     * @inheritdoc
     */
    ...
    public function beforeSave($insert)
    {
        ...
        $this->type = Banner::TYPE_NEW_PRODUCTS;
    ...
    */
    ...
    {
        $query = static::find()->where(['type' => Banner::TYPE_NEW_PRODUCTS]);
    ...
    */
    ...
    {
        return 'Баннеры для страницы новинок';
    }
}
