 ...
 */
class CatalogBanner extends \backend\components\BackModel
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            ['type', 'default', 'value' => Banner::TYPE_CATALOG],
    ...
    */
    ...
    {
        $query = static::find()->where(['type' => Banner::TYPE_CATALOG]);
    ...
    */
    ...
    {
        return 'Баннеры для главной страницы каталога';
    }
}
