...
/**
 * Class m141225_093157_add_store_product_attribute_options_table_lang */
class m141225_093157_add_store_product_attribute_options_table_lang extends Migration
{
    /**
     ...
     */
    public $relatedTableName = '{{%store_product_attribute_option_lang}}';
    ...
    public function safeUp()
    {
        ...
        $this->addForeignKey(
            'fk_store_product_attribute_option_lang_model_id_to_main_model_id',
            $this->relatedTableName,
            'model_id',
            $this->tableName,
            'id',
