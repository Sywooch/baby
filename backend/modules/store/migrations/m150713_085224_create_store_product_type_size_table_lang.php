...
/**
 * Class m150713_085224_create_store_product_type_size_table_lang */
class m150713_085224_create_store_product_type_size_table_lang extends Migration
{
    /**
     ...
     */
    public $relatedTableName = '{{%store_product_type_size_lang}}';
    ...
    public function safeUp()
    {
        ...
        $this->addForeignKey(
            'fk_store_product_type_size_lang_model_id_to_main_model_id',
            $this->relatedTableName,
            'model_id',
            $this->tableName,
            'id',
        ...
        $this->addForeignKey(
            'fk_store_product_type_size_lang_lang_id_to_language_id',
            $this->relatedTableName,
            'lang_id',
            '{{%language}}',
            'locale',
