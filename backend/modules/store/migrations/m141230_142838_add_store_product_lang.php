...
/**
 * Class m141230_142838_add_store_product_lang */
class m141230_142838_add_store_product_lang extends Migration
{
    /**
     ...
     */
    public $relatedTableName = '{{%store_product_lang}}';
    ...
    public function safeUp()
    {
        ...
        $this->addForeignKey(
            'fk_store_product_lang_model_id_to_main_model_id',
            $this->relatedTableName,
            'model_id',
            $this->tableName,
            'id',
