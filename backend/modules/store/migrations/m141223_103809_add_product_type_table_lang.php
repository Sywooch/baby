...
/**
 * Class m141223_103809_add_product_type_table_lang */
class m141223_103809_add_product_type_table_lang extends Migration
{
    /**
     ...
     */
    public $relatedTableName = '{{%store_product_type_lang}}';
    ...
    public function safeUp()
    {
        ...
        $this->addForeignKey(
            'fk_store_product_type_lang_model_id_to_main_model_id',
            $this->relatedTableName,
            'model_id',
            $this->tableName,
            'id',
