 ...
 */
class StoreProductCategorySort extends StoreProductSorting
{
    /**
     * @inheritdoc
     */
    public function behaviors()
    {
        return [
            'sort' => [
                ...
                'sortableAttribute' => 'top_category_position'
            ],
        ];
    }
    ...
    public function search($params)
    {
        $query = static::find()
            ->with(['mainImage'])
            ->where(['is_top_50_category' => 1]);

        $dataProvider = new ActiveDataProvider([
            'query' => $query,
            'sort'=> ['defaultOrder' => ['top_category_position'=> SORT_DESC]]
        ]);
    ...
    {
        return 'Сортирова ТОП-50 категорий';
    }
}
