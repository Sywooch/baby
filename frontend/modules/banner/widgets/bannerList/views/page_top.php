...
<div class="h-slider inactive" data-rel="slider-1">
    ...
    foreach ($banners as $banner) {
        ...
        $content = Html::tag($tagForBannerHeader, Html::tag('span', $banner->label), ['class' => 'title title-padding']);
        $content .= Html::tag('span', $banner->content, ['class' => 'text']);
        ...
        if (!empty($banner->href)) {
            ...
            echo Html::a($content, $banner->href, ['class' => 'descr-big '.$class]);
        } else {
            echo Html::tag('div', $content, ['class' => 'descr-big '.$class]);
        }
